...
<body background="/FlyAway/bgImg.jpg">
	...
	<form method="post" action="UserLogin">
		<table align="center" style="width: 25%; height: 20%; background-color: rosybrown; border: 1px solid black;">
			<tr>
				<td colspan=3 align="center"><font size=5><b>User Login</b></font></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3" align="right"><a href="CreateAccount.jsp">Create Account</a></td>
			</tr>
		</table>
	</form>
</body>
